...
(function() {
  var SequenceMatcher; var arrayDiff; var colorize; var descalarize; var diff; var diffScore; var diffString; var diffWithScore; var extendedTypeOf; var findMatchingObject; var isScalar; var isScalarized; var objectDiff; var scalarize;
  ...
  objectDiff = function(obj1, obj2, options) {
    ...
    // patch!
    if (Object.keys(result).length === 0 || subscore === 100) {
      // ref1 = [100 * Math.max(Object.keys(obj1).length, 0.5), void 0], score = ref1[0], result = ref1[1];
      ref1 = [ 100 * Math.max(Object.keys(obj1).length, 0.5), void 0 ], score = ref1[0];
    } else {
  ...
  arrayDiff = function(obj1, obj2, options) {
    var allEqual, change, i, i1, i2, item, item1, item2, j, j1, j2, k, l, len, m, n, o, op, opcodes, originals1, originals2, p, q, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, refs, result, score, subscore, seq1, seq2;
    if (options == null) {
      options = {};
    }
    originals1 = {
      ...
      case 'equal':
        for (i = l = ref1 = i1, ref2 = i2; ref1 <= ref2 ? l < ref2 : l > ref2; i = ref1 <= ref2 ? ++l : --l) {
          ...
          if (isScalarized(item, originals1)) {
            ...
            // patch!
            refs = diffWithScore(item1, item2, options);
            subscore = refs[0];
            change = refs[1];
            if (change) {
              result.push([ '~', change ]);
              allEqual =  subscore === 100;
            } else {
              result.push([ ' ' ]);
            }
          } else {
      ...
      case 'replace':
        if (!options.keysOnly) {
          ...
          for (i = q = ref11 = i1, ref12 = i2; ref11 <= ref12 ? q < ref12 : q > ref12; i = ref11 <= ref12 ? ++q : --q) {
            // patch!
            refs = diffWithScore(descalarize(seq1[i], originals1), descalarize(seq2[i - i1 + j1], originals2), options);
            subscore = refs[0];
            change = refs[1];
            if (change) {
              result.push([ '~', change ]);
